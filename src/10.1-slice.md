...
entry   assume (facts → flags)
          ...
          Init(self, T, len)    →  alloc .initialized
          Alive(self)           →  alloc .alive_assumed
...
_3 = &(*_4)                                             [checkpoint (2)]
          ...
          check  Init(_4, T, 1)    ←  alloc .initialized            Proved
          check  Align(_4, T)      ←  alloc .align, offset % align == 0   Proved
