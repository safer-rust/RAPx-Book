...
_6 = &raw const (*_1)
          VM  _6.term = _1.term, _6.prov = _1.prov, _6.flags = { non_null, in_bounds }
...
_3 = &(*_4)                                             [checkpoint (2)]
          ...
          check  Align(_4, T)        ←  required alignment = 1 (concrete minimum for unconstrained T), so every pointer satisfies it    Proved
...
_8 = &raw mut (*_1)
          VM  _8.term = _1.term, _8.prov = _1.prov, _8.flags = { non_null, in_bounds }
...
_5 = &mut (*_6)                                           [checkpoint (2)]
          ...
          check  Align(_6, T)        ←  required alignment = 1 (concrete minimum for unconstrained T), so every pointer satisfies it    Proved
...
_11 = as_mut_ptr(&mut (*_1))
          VM  _11.term = _1.term, _11.prov = _1.prov

_14 = ptr.add(copy _11, _2)
          VM  _14.term = _11.term + _2.term*sizeof_T, _14.prov = (data_alloc, _2.term*sizeof_T)

_17 = ptr.add(copy _11, _3)
          VM  _17.term = _11.term + _3.term*sizeof_T, _17.prov = (data_alloc, _3.term*sizeof_T)

_13 = ptr::swap(move _14, move _17)                        [checkpoint]
          check  ValidPtr(_14, T, 1)  ←  NonNull (flag) + Allocated/InBound by `_2.term < len`    Proved
          check  Align(_14, T)        ←  align = 1                                              Proved
          check  ValidPtr(_17, T, 1)  ←  NonNull (flag) + Allocated/InBound by `_3.term < len`    Proved
          check  Align(_17, T)        ←  align = 1                                              Proved
