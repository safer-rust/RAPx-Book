...
entry   _1 = self (&[T]), _2 = index (I)
          ...
          caller contracts (asserted as facts):
            ...
            NonNull(self)            = self as usize != 0           →  _1.non_null
            Init(self, T, len(self)) = all len(self) elements init  →  alloc(_1).initialized
            Alive(self)              = *self outlives return        →  alloc(_1).alive_assumed
