...
```text
entry   _1 = self (&mut [T]), _2 = index (I)                         [slice invariant]
          data_alloc.slice_len = len, data_alloc.element_ty = T
          fact: InBound(_1, _2) → _2.term < len

_6 = get_unchecked_mut(move _7, move _8)                            [checkpoint (1)]
          check  InBound(_8, _7)  ←  _2.term < len                                  Proved

_5 = &mut (*_6)                                                     [checkpoint (2)]
          check  Init + NonNull + Allocated + InBound + Align  ←  same as get_unchecked   Proved
          check  Alias(_6)  ←  resolve_origin → _1 (&mut self, exclusive)                Proved

_4/_3/_0 = &mut (*_…)   (safe reborrows → return slot; no checkpoint)
