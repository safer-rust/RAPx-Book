...
_3 = &(*_4)                                             [checkpoint (2)]
          ...
          check  Allocated(_4, T, 1) ←  SMT: assert ¬(`(_5.term+1)*sizeof_T ≤ len*sizeof_T`) — unsat by `_5.term < len`, `sizeof_T ≥ 1` ⇒ UNSAT    Proved
          check  InBound(_4, T, 1)   ←  SMT: assert `(_5.term+1)*sizeof_T > len*sizeof_T` ∨ `_5.term*sizeof_T < 0` — first unsat by `_5.term < len`, second unsat by `_5.term ≥ 0` (usize) ⇒ UNSAT    Proved
...
_5 = &mut (*_6)                                           [checkpoint (2)]
          ...
          check  Allocated(_6, T, 1) ←  SMT: assert ¬(`(_7.term+1)*sizeof_T ≤ len*sizeof_T`) — unsat by `_7.term < len`, `sizeof_T ≥ 1` ⇒ UNSAT    Proved
          check  InBound(_6, T, 1)   ←  SMT: assert `(_7.term+1)*sizeof_T > len*sizeof_T` ∨ `_7.term*sizeof_T < 0` — first unsat by `_7.term < len`, second unsat by `_7.term ≥ 0` (usize) ⇒ UNSAT    Proved
