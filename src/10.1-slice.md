...
**Verification.** The path, top to bottom — entry facts, then each MIR statement, then the return re-proof:

| CP | MIR statement | VM effect | Contract | Constraint |
|----|--------------|-----------|----------|------------|
| entry | — | — | — | assume: `InBound(index_access(self, index))`, `&[T]` slice invariant |
...
| ret | `return` | — | type-invariant: `NonNull` + `Init` + `Alive` | ← entry invariant |
...
| CP | MIR statement | VM effect | Contract | Constraint |
|----|--------------|-----------|----------|------------|
| entry | — | — | — | assume: `InBound(index_access(self, index))`, `&mut [T]` slice invariant |
