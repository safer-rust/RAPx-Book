...
_5 = &mut (*_6)                                           [checkpoint (2)]
          ...
          check  Align(_6, T)        ←  required align = align_T; real align_n = align_T ⇒ proved    Proved
          check  Alias(_6)           ←  (hazard) resolve_origin(_6) → _1 (&mut self, exclusive) ⇒ unique view safe    Proved
