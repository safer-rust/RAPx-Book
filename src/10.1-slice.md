...
| (1) | `_4 = get_unchecked(move _5, move _6)` | `InBound(_6, _5)` | provenance: `_4 → _6 → _1` | ← `InBound(index_access(_1, _2))` |
| (2) | `_3 = &(*_4)` | `Ptr2Ref` | reference from raw `_4` | `Init`/`Align` ← `_1` invariant; `Alias` ← shared |
