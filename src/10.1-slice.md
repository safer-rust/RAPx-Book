...
_3 = &(*_4)                                             [checkpoint (2)]
          ...
          check  InBound(_4, T, 1)   ←  SMT: `(_5.term+1)*sizeof_T > len*sizeof_T` unsat by `_5.term < len`, `sizeof_T ≥ 1`; but `_5.term ≥ 0` (usize) not asserted → Unknown
...
_5 = &mut (*_6)                                           [checkpoint (2)]
          ...
          check  InBound(_6, T, 1)   ←  SMT: `(_7.term+1)*sizeof_T > len*sizeof_T` unsat by `_7.term < len`, `sizeof_T ≥ 1`; but `_7.term ≥ 0` (usize) not asserted → Unknown
