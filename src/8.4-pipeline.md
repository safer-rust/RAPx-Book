...
The `PropertyChecker` ([`property_checker`](https://github.com/safer-rust/RAPx/blob/main/rapx/src/verify/property_checker/mod.rs)) translates the VM state into Z3 assertions and checks each safety property:
