...
- **Alias Analysis (Chapter 5.2)**: Dataflow graphs provide value-equivalence information that complements alias relationships.
- **SafeDrop (Chapter 6.1)**: Uses dataflow analysis to determine whether a value flows to a deallocation site.
- **Verification (Chapter 7)**: The forward visitor uses def-use chains similar to dataflow's ancestor/descendant queries.
