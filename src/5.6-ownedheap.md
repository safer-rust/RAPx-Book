...
Owned heap analysis determines whether a Rust type owns heap-allocated memory. This information is essential for [memory leak detection](./6.2-memleak.md) and other analyses that must distinguish stack-only types from those requiring deallocation. The module lives at [`rapx/src/analysis/owned_heap/`](https://github.com/safer-rust/RAPx/tree/main/rapx/src/analysis/owned_heap/).
