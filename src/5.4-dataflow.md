...
```shell
cargo rapx analyze dataflow --debug
```
...
```rust
use analysis::dataflow::default::DataflowAnalyzer; // import the module
let dataflow = DataflowAnalyzer::new(tcx, false); // create a dataflow object
