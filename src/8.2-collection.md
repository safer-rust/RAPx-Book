...
1. Direct annotation: `#[rapx::requires(...)]` on the callee itself. See [Chapter 8.3.2](./8.3-contracts.md#8321-direct-annotation).
...
3. JSON database: For standard library functions that can't be annotated upstream, contracts are loaded from a bundled database. See [Chapter 8.3.2](./8.3-contracts.md#8322-json-contracts).
