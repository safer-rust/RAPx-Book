...
RAPx provides a default implementation of `RangeAnalysis` trait in [range_analysis.rs](https://github.com/safer-rust/RAPx/blob/main/rapx/src/analysis/core/range_analysis.rs). The implementation is inspired by the following CGO paper.
